...
st.write('Have you ever played the \'The Game of Life\'?  Well if you have not, then here\'s a brief overview.\
         ...
         to choose between getting a college degree or just start playing and look for a job. Everytime you reach \
         A career point, you will be faced with three jobs to choose from. Some of them will require haveing a\
         ...
         \'life\' such as getting married, investing some money, or choosing another career. \n')
st.write("As a college student, you need to make some decisions that may affect your life on the long run.\
...
st.write("In this application, we will try to help you decide whether you need to put in the effort or not. To do so\
        ...
        , employers, needed qualifications, salaries ...etc.\
         To get more information about the data used in this application, chechout the 'About Data' tab.")
